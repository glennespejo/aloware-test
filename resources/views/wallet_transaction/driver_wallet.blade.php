...
@endsection
<div id="app">
    <user-wallet-transaction :user="{{json_encode($user)}}" :user-wallet-url="{{json_encode(route('wallet-transactions.index'))}}"></user-wallet-transaction>
</div>
<!-- END Search -->
@endsection
@section('scripts')
    ...
    <script src="{{mix('compiled/js/wallet_transaction/user_wallet_transaction.js')}}"></script>
@endsection
